...
class ExportFormDialog extends StatefulWidget {
  ...
  @override
  State<ExportFormDialog> createState() => _ExportFormDialogState();
}
...
class _ExportFormDialogState extends State<ExportFormDialog> {
  ...
  final TextEditingController _ckController = TextEditingController();
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Expanded(child: _buildTextField(_customerCodeController, 'Mã KH')),
                      const SizedBox(width: 8),
                  ...
                  Row(
                    children: [
                      Expanded(child: _buildTextField(_ckController, 'CK')),
                      const SizedBox(width: 8),
                      Expanded(child: _buildTextField(_vatController, 'VAT')),
                      const SizedBox(width: 8),
                      Expanded(child: _buildTextField(_totalController, 'Tổng tiền')),
                      const SizedBox(width: 8),
                      Expanded(child: _buildTextField(_payController, 'Thanh toán')),
                      const SizedBox(width: 8),
                      Expanded(child: _buildTextField(_remainingController, 'Còn lại')),
                    ],
                  ),
                  const SizedBox(height: 12),
                  Row(
